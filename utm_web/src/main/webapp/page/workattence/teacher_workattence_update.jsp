...
<div class="pageContent">
	...
	<form method="post" action="${contextPath}/workattence/updateTeacherWorkattenceAction.action" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
		<div class="pageFormContent" layoutH="58">
            <input type="hidden" name="workattence.id" value="${workattence.id}"/>
            <div class="unit">
                <label>卡号：</label>
                <input type="text" name="workattence.teacherByTeacherid.code" value="${ workattence.teacherByTeacherid.code }" size="30" maxlength="20"  class="alphanumeric required" readonly="true"/>
            </div>
            <div class="unit">
                <label>登入日期：</label>
