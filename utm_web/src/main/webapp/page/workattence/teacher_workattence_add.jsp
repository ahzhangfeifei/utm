...
<div class="pageContent">
	...
	<form method="post" action="${contextPath}/workattence/addTeacherWorkattenceAction.action" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
				<div class="pageFormContent" layoutH="58">
                    <jsp:useBean id="now" class="java.util.Date" />
			<div class="unit">
				<label>卡号：</label>
				<input type="text" name="workattence.teacherByTeacherid.code" value="" size="30" maxlength="20"  class="alphanumeric required" />
			</div>
			<div class="unit">
				<label>登入日期：</label>
